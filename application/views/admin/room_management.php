        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <a href="<?= base_url('admin/roomadd') ?>" class="btn btn-info d-none d-lg-block m-l-15 text-light"><i class="fa fa-plus-circle"></i> Create New</a>
                </div>
            </div>
        </div>
        <div class="row">
	                	...
	                	<table id="rooms_table" class="display nowrap table table-hover table-responsive-md table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    	<button class="btn btn-sm btn-primary btn-circle text-white action-edit" rel="tooltip" data-toggle="modal"  data-target=".bs-example-modal-lg" data-id="<?= $user->id ?>" data-original-title="Edit"><i class="fas fa-pencil-alt"></i></button>
                                    	<button class="btn btn-sm btn-danger btn-circle text-white action-remove" rel="tooltip" data-original-title="Trash" data-id="<?= $user->id ?>"><i class="fas fa-trash-alt"></i></button>
